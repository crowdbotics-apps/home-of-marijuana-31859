...
## Project Structure
    ...
    ├── home_of_marijuana_31859  # Django project configurations
...
1. Clone this repo and `cd home_of_marijuana_31859`
...
2. Clone this repo and `cd home_of_marijuana_31859`
